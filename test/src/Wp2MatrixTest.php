...
class Wp2MatrixTest extends TestCase {
	...
	public function testContructor() {
		$w2m = new Wp2Matrix();
		self::assertTrue(has_action('admin_init', [Wp2Matrix::class, 'onInit']));
		self::assertTrue(has_action('admin_menu', [Wp2Matrix::class, 'onMenu']));
		self::assertTrue(has_action('publish_post', [Wp2Matrix::class, 'onPostPublish']));
		self::assertTrue(has_filter('pre_update_option', [Wp2Matrix::class, 'onPreUpdate']));
	}
